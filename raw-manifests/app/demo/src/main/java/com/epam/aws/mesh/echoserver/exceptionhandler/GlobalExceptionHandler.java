...
import com.epam.aws.mesh.echoserver.domain.ApiError;
...
public class GlobalExceptionHandler {
    ...
    public final ResponseEntity<ApiError> handleException(Exception ex, WebRequest request) {
        ...
        if (ex instanceof ServerNotFoundException) {
            ...
            ServerNotFoundException unfe = (ServerNotFoundException) ex;

            return handleServerNotFoundException(unfe, headers, status, request);
     ...
     */
    protected ResponseEntity<ApiError> handleServerNotFoundException(ServerNotFoundException ex,
